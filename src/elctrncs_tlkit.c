...
Electronics toolkit. A simple electronics calculator. Copyright (C) 2018 Ian Mitchell Ian.Mitchell_001@gmx.com This program is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.
...
float ohm(); float ohm(){ // Main variables for voltage, resistance, current, and power. // Volts, ohms, amps, watts float V, R, I, P; // Variables for AC circuits. Just mainly reactance. // Ohms float chi;
